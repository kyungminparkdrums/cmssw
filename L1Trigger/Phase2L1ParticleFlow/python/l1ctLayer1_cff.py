...
l1tLayer1HGCal = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            wp_PU = cms.vdouble(0.31566055, 0.29068643),
            wp_Pi = cms.vdouble(0.39041490, 0.32827856),
            wp_PFEm = cms.vdouble(0.19288833, 0.50007864),
            wp_EgEm = cms.vdouble(0.19288833, 0.50007864),
            wp_EgEm_tight = cms.vdouble(0.43461812, 0.50007864),
