...
l1tLayer1HGCal = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            #wp_PU = cms.vdouble(0.25832766, 0.65156879),
            #wp_Pi = cms.vdouble(0.28106467, 0.05198044),
            #wp_EgEm = cms.vdouble(0.23633461, 0.17099993),
            #wp_PFEm = cms.vdouble(0.23633461, 0.17099993),
            
            #wp_PU = cms.vdouble(0.33281650, 0.42517368),
            #wp_Pi = cms.vdouble(0.25834703, 0.09675570),
            #wp_EgEm = cms.vdouble(0.26790839, 0.30390717),
            #wp_PFEm = cms.vdouble(0.26790839, 0.30390717),
            ...
            #wp_PU = cms.vdouble(0.33672983, 0.12315466),
            #wp_Pi = cms.vdouble(0.26018271, 0.03372935),
            #wp_EgEm = cms.vdouble(0.15924495, 0.53548360),
            #wp_PFEm = cms.vdouble(0.15924495, 0.53548360),
        ),
