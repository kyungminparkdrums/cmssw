...
l1tLayer1HGCal = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            wp_PU_noTk = cms.vdouble(0.42100209, 0.52275714),
            wp_Pi_noTk = cms.vdouble(0.0, 0.0),
            wp_PFEm_noTk = cms.vdouble(0.35924579, 0.67921004),
            wp_EgEm_noTk = cms.vdouble(0.35924579, 0.67921004),
            wp_EgEm_tight_noTk = cms.vdouble(0.76317512, 0.67921004),
        ),
