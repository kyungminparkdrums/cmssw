...
l1tLayer1HGCal = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            wp_Pi = cms.vdouble(0.26773010, 0.26773010, 0.03898286, 0.03898286),
            wp_PFEm = cms.vdouble(0.29812516, 0.29812516, 0.42790125, 0.42790125),
            wp_EgEm = cms.vdouble(0.29812516, 0.29812516, 0.42790125, 0.42790125),
            wp_EgEm_tight = cms.vdouble(0.76317512, 0.76317512, 0.67921004, 0.67921004),
        ),
...
l1tLayer1HGCalNoTK = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            wp_Pi = cms.vdouble(0.12800815, 0.12800815, 0.20509825, 0.20509825),
            wp_PFEm = cms.vdouble(0.35924579, 0.35924579, 0.67921004, 0.67921004),
            wp_EgEm = cms.vdouble(0.35924579, 0.35924579, 0.67921004, 0.67921004),
            wp_EgEm_tight = cms.vdouble(0.76317512, 0.76317512, 0.67921004, 0.67921004),
        ),
        corrector = cms.string("L1Trigger/Phase2L1ParticleFlow/data/hadcorr_HGCal3D_TC.root"),
        correctorEmfMax = cms.double(1.125),
