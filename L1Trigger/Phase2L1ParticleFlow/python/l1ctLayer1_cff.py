...
l1tLayer1HGCal = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            wp_PU = cms.vdouble(0.31566055, 0.38955797),
            wp_Pi = cms.vdouble(0.39041490, 0.43719233),
            wp_PFEm = cms.vdouble(0.19288833, 0.59687518),
            wp_EgEm = cms.vdouble(0.19288833, 0.59687518),
            wp_EgEm_tight = cms.vdouble(0.43461812, 0.59687518),
            wp_PU_noTk = cms.vdouble(0.35541089, 0.57062365),
            wp_Pi_noTk = cms.vdouble(0.12800815, 0.20509825),
            wp_PFEm_noTk = cms.vdouble(0.24658062, 0.53282408),
            wp_EgEm_noTk = cms.vdouble(0.24658062, 0.53282408),
            wp_EgEm_tight_noTk = cms.vdouble(0.24658062, 0.53282408),
        ),
